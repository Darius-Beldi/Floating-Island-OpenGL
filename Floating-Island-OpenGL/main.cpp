...
void CreateVBO(void)
{
	...
	// Alocă spațiu pentru poziții, normale și culori
	...
	glBufferSubData(GL_ARRAY_BUFFER, vertices.size() * sizeof(glm::vec3) + normals.size() * sizeof(glm::vec3), colors.size() * sizeof(glm::vec3), &colors[0]);
...
void Initialize(void)
{
	...
	// Incarcarea modelului 3D in format OBJ
	bool model = loadOBJ("Assets/Scena.obj", vertices, uvs, normals, colors);
